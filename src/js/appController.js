        ...
        function (oj, ko, moduleUtils) {
            function ControllerViewModel() {
                ...
                self.router.configure({
                    'scatterChart ': {label: 'Scatter Chart ', isDefault: true},
                    'boxPlotChart': {label: 'Box Plot Chart'},
                    'simpleChart': {label: 'Simple Chart'},
                    'about': {label: 'About'}
                });
                ...
                // Navigation setup
                var navData = [
                    {name: 'Simple Charts', id: 'simpleChart',
                ...
                self.userLogin = ko.observable("sadik.younsse@gmail.com");
